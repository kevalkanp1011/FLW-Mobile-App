...
data class CDRCache (
    ...
    fun asPostModel(user: UserCache, household: HouseholdCache, ben: BenRegCache, cdrCount: Int): CDRPost {
        return CDRPost(
            ...
            villageid = household.locationRecord.villageId,
            ...
            cdrColony = mohalla,
            cdrBlock = household.locationRecord.block,
            cdrDistrict = household.locationRecord.district,
            cdrState = household.locationRecord.state,
