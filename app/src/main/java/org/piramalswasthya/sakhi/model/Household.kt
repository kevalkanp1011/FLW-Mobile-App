...
data class HouseholdCache(
    ...
    var benId: Long? = null,
    @Embedded(prefix = "fam") var family: HouseholdFamily? = null,
    @Embedded(prefix = "det") var details: HouseholdDetails? = null,
    @Embedded(prefix = "amen") var amenities: HouseholdAmenities? = null,
    @Embedded(prefix = "loc") val locationRecord: LocationRecord,
    //Spam
