...
//    fun getIndexOfExpectedDateOfDelivery() = dataset.getIndexOfExpectedDateOfDelivery()
    ...
    /*suspend fun getFirstPage(): List<FormInputOld> {
        ...
        return if (_recordExists.value == false) {
            ...
            if (form.hasReproductiveStatus()) _hasReproductiveStatus.value = true
...
//                        }
//                    } else list.remove(form.dateOfMarriage)
//                    adapter.submitList(list)
//                }
//
//
...
//                                    list.add(
//                                        adapter.currentList.indexOf(form.maritalStatus) + 1, item
//                                    )
//                                }
//                            }
//                        } else {
...
//                    } ?: run {
//                        val list = adapter.currentList.toMutableList()
//                        if (adapter.currentList.contains(form.ageAtMarriage)) list.remove(form.ageAtMarriage)
//                        if (adapter.currentList.contains(form.husbandName)) list.remove(form.husbandName)
//                        if (adapter.currentList.contains(form.wifeName)) list.remove(form.wifeName)
//                        if (adapter.currentList.contains(form.spouseName)) list.remove(form.spouseName)
//                        adapter.submitList(list)
//                    }
//                }
//            }
...
//        return if (_recordExists.value == false) {
//            form.secondPage
//        } else form.loadSecondPageOnViewModel()
//
//    }
...
//        return if (_recordExists.value == false) {
//            form.thirdPage
//        } else form.loadThirdPageOnViewModel()
//    }
...
//                                if (adapter.currentList.contains(form.lastMenstrualPeriod)) adapter.notifyItemChanged(
//                                    adapter.currentList.indexOf(form.lastMenstrualPeriod)
//                                )
//                                Timber.d("entries : ${form.thirdPage}")
//                            }
//                            "Antenatal Mother", "Delivery Stage" -> {
...
//
//                                list.add(
//                                    list.indexOf(form.reproductiveStatus) + 1, form.dateOfDelivery
//                                )
//
//                            }
//                            else -> {
...
//
//                                list.add(
//                                    1, form.reproductiveStatusOther
//                                )
//                            }
//
//                        }
...
//                            if (!list.contains(form.nishchayKitDeliveryStatus)) list.add(
//                                list.indexOf(form.lastMenstrualPeriod) + 1,
...
//                        val list = adapter.currentList.toMutableList()
//                        when (it) {
//                            "PHC", "HWC", "CHC", "District Hospital" -> {
//                                list.remove(form.otherPlaceOfDelivery)
//                                if (!list.contains(form.facility)) {
//                                    list.add(
//                                        list.indexOf(form.lastDeliveryConducted) + 1, form.facility
//                                    )
//                                }
//                            }
//                            "Medical college Hospital", "Other" -> {
