...
class NcdNonEligibleListFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = NcdNonEligibleListFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ncd_non_eligible_list, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        viewModel = ViewModelProvider(this).get(NcdNonEligibleListViewModel::class.java)
